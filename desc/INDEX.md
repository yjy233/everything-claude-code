...
| 文档 | 内容 | 建议阅读时间 |
|------|------|-------------|
| [README.md](./README.md) | 项目整体介绍 | 10 分钟 |
| [QUICK_START.md](./QUICK_START.md) | 5 分钟快速入门 | 5 分钟 |
...
### 路径 1: 快速了解 (15 分钟)
```
QUICK_START.md ──► AGENTS_CHEATSHEET.md
```

### 路径 2: 深入理解 (1 小时)
```
README.md ──► ARCHITECTURE.md ──► AGENTS_GUIDE.md
```
...
### 路径 4: 上手使用 (1 小时) ⭐ 推荐
```
QUICK_START.md ──► HOW_TO_USE_AGENTS.md ──► USAGE_EXAMPLES.md
```
...
### 项目介绍类
- **README.md** - 项目概览、核心功能、使用示例
- **QUICK_START.md** - 快速上手、核心命令、安装方式

### 架构设计类
- **ARCHITECTURE.md** - 系统架构图、组件详解、数据流
...
### 使用实战类 ⭐
- **HOW_TO_USE_AGENTS.md** - 三种使用方式详解
- **USAGE_EXAMPLES.md** - 完整实战示例
